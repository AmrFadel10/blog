...
import { updateProfileApiCall } from "../redux/apicalls/ProfileApiCall";
...
const UpdateProfileModal = ({ setUpdateProfile, profile }) => {
  ...
  const formSubmitHandler = (e) => {
    ...
    dispatch(updateProfileApiCall(profile._id, updatedUser));
      ...
      <form onSubmit={formSubmitHandler} className="update-profile-form">
        <abbr title="close">
          <i
            ...
            className="fa-solid fa-xmark update-profile-form-close"
          ></i>
        </abbr>
